...
export function StatsCard({
  ...
  return (
    <div className="bg-yt-bg-secondary rounded-xl p-5 border border-yt-border hover:border-yt-border/80 transition-colors">
      <div className="flex items-center justify-between mb-1">
        <span className="text-sm text-yt-text-secondary font-medium">{title}</span>
        {icon && <div className="text-yt-text-secondary">{icon}</div>}
      </div>
